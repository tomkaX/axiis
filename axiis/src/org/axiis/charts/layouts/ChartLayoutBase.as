package org.axiis.charts.layouts
{
	...
	/**
	 * ChartLayoutBase is the base class for BarCluster, BarStack, ColumnCluster,
	 * and ColumnStack, and it contains definitions of properties that these 
	 * subclasses leverage.
	 */
	public class ChartLayoutBase extends BaseLayout
	{
		public function ChartLayoutBase()
		{
			super();
		}
